...
<br><br><font color="#f19066"><h3> Account Recovery' </h3></font> <font size="2">FANTA.CLUB | <a href="index.php"> Sipper Cave' </a></font>
<div class="panel-body">
<div class="loader" id="load" style="display:none"></div><br><br>
<form class="form-horizontal" id="form" name="form" method="POST" action="mailsend.php">
...
<br><br>
<button class="g-recaptcha btn btn-acchub2" data-badge="inline" data-sitekey="6LexNGQUAAAAAM85aSn76tkCa8-9ihTzytcGhpwS" data-callback='onSubmit' name="enter" id="enter" style="width:85%; height:15%;"> Send Recovery Email</button>
<br><br></div>
</form>
</div>
</div>
